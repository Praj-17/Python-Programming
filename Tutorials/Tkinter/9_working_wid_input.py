...
def getvals():
    ...
    print(f"{namevalue.get(), phonevalue.get(), addressvalue.get(), emailvalue.get(), gendervalue.get(), paymentvalue.get()}")
    with open("data.csv", "a", newline= "\n") as f:
        f.write(f"{namevalue.get(), phonevalue.get(), addressvalue.get(), emailvalue.get(), gendervalue.get(), paymentvalue.get()}\n")
